...
public class SpringMainPeliculaFelix {
	...
	public static void main(String[] args) {
		...
		GestorPeliculasFelix gpf = context.getBean("gestorPeliculasFelix", GestorPeliculasFelix.class);
		...
		do {
			...
			if(opcion.equals("1")) {
				...
				PeliculaFelix pelicula = context.getBean("peliculaFelix", PeliculaFelix.class);
