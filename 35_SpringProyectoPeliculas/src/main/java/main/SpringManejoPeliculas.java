...
public class SpringManejoPeliculas {
	...
	public static void main(String[] args) {
		...
		sc = context.getBean("scanner", Scanner.class);
...
Cuando busquemos una pelicula por titulo deberemos de mostrar toda la información relevante a la pelicula
		...
		ArrayList<Pelicula> listaPeliculas = context.getBean("listaPeliculas", ArrayList.class);
	...
	private static void altaPelicula(ArrayList<Pelicula> listaPeliculas) {
		...
		Pelicula pelicula = context.getBean("peliculaManejo", Pelicula.class);
		Director director = context.getBean("directorManejo", Director.class);
