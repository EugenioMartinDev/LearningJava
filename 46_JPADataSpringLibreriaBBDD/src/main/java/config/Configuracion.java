...
//Le decimos a Spring que esta clase va a contener @Bean aunque no es necesario si no se introduce como parámetro en la creación del contexto
@Configuration
//Le decimos a Spring que vamos a trabajar con un repositorio JPA y el paquete dónde se encuentra. Se puede o no poner la etiqueta @Repository en el dao.
@EnableJpaRepositories(basePackages= {"modelo.persistencia"})
//Le decimos a Spring donde buscar los objetos. Podríamos definir igualmente @Component en la clase Pelicula
