...
@EnableJpaRepositories(basePackages= {"directorio.modelo.persistencia"})
...
public class ConfiguracionJPAData {
	...
	public DataSource dataSource() {
		...
		ds.setUrl("jdbc:mysql://localhost:3306/64_directorio?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
		ds.setUsername("root");
		ds.setPassword("root");
		return ds;
	}
	...
	public LocalContainerEntityManagerFactoryBean 
		...
		entityManagerFactoryBean.setPackagesToScan("directorio.modelo.entidad");
